...
async function generateAICopy({ businessName, industry, templateId }) {
...
"[project]/lib/modules/websites/qa-service.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function selectTemplate(lead, quality = "basic") {
    const industry = (lead.industry || "").toLowerCase().trim();
    // Map industries to template IDs
    if (industry.includes("restaurant") || industry.includes("food")) return "restaurant-v1";
    if (industry.includes("service") || industry.includes("plumb") || industry.includes("electr")) return "service-business-v1";
    if (industry.includes("shop") || industry.includes("retail")) return "retail-v1";
    // Default
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$modules$2f$websites$2f$qa$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/modules/websites/qa-service.ts [app-rsc] (ecmascript)");
...
async function generateWebsitesAction() {
    ...
    const { data: leads } = await supabase.from("leads").select("id, business_name, industry").limit(5);
    ...
    for (const lead of leads){
        ...
        if (!existing) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$modules$2f$websites$2f$orchestrator$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createWebsiteForLead"])(lead.id, {
                    quality: "basic"
                });
                count++;
            } catch (error) {
    ...
    return {
        success: true,
        message: count > 0 ? `Successfully generated ${count} websites.` : "No new websites needed to be generated."
    };
}
;
...
"[project]/.next-internal/server/app/admin/websites/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/admin/websites/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/admin/websites/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/admin/websites/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$admin$2f$websites$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$app$2f$admin$2f$websites$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/admin/websites/page/actions.js { ACTIONS_MODULE0 => "[project]/app/admin/websites/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$admin$2f$websites$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/admin/websites/actions.ts [app-rsc] (ecmascript)");
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__210d518e._.js.map